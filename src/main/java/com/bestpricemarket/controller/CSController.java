...
//	}
	...
	public void contentGET(@RequestParam("csbno") int csbno, Model model) throws Exception {
	...
	public void CSBoardListPageGET(Model model, @RequestParam("num")int num) throws Exception {
		//num = 페이지 번호

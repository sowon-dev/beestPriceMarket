...
<fieldset>
    ...
    <form action="/member/update" method="post">
     <br> ID : <input type="text" name="id" class="form-control"value="${memberVO.id }" style= "width: 226px;"> <br>
          PW : <input type="password" class="form-control" name="pw"  style="width: 226px;"> <br>
     
      <input type="submit" class="btn" value="회원탈퇴"  name="commit">          
    </form>  
  </fieldset>
  <!-- Footer -->

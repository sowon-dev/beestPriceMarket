    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="list-group">
          <a href="/goods/list" class="list-group-item">Category 1</a>
          <a href="/goods/list" class="list-group-item">Category 2</a>
          <a href="/goods/list" class="list-group-item">Category 3</a>
        </div>
